...
Write-Host ""
$servurl = Read-Host "🌐 SERV-URL"
Write-Host ""
$modelo  = Read-Host "📦 MODELO"

Write-Host ""
Write-Host "[+] Gerando arquivo..." -ForegroundColor Yellow

# =========================
# AQUI FOI O PRINCIPAL FIX
# =========================
...
while (`$true) {
    ...
    Write-Host "`n[`$CurrentChat] Você > " -ForegroundColor Green -NoNewline
    `$input = Read-Host
...
"@ | Out-File -Encoding UTF8 chat.ps1
